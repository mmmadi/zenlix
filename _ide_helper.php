 ...
 * Generated for Laravel 5.1.37 (LTS) on 2016-08-04.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \zenlix\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \zenlix\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \zenlix\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \zenlix\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \zenlix\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \zenlix\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \zenlix\Console\Kernel::bootstrap();
        }
    ...
    class Zen extends \zenlix\Classes\Zen{
    ...
    class Adldap extends \Adldap\Laravel\Facades\Adldap{
         ...
         *
         * @return bool|\Adldap\Contracts\ConnectionInterface 
         * @static 
         */
        public static function getConnection(){
            return \Adldap\Adldap::getConnection();
        }
        
        /**
         * Sets the connection property.
         *
         * @param \Adldap\Contracts\ConnectionInterface $connection
         * @static 
         */
        public static function setConnection($connection){
            return \Adldap\Adldap::setConnection($connection);
        }
        
        /**
         * Returns the configuration object.
         *
         * @return \Adldap\Contracts\Configuration 
         * @static 
         */
        public static function getConfiguration(){
            return \Adldap\Adldap::getConfiguration();
        }
        
        /**
         * Sets the configuration property.
         *
         * @param \Adldap\Contracts\Configuration $configuration
         * @static 
         */
        public static function setConfiguration($configuration){
            return \Adldap\Adldap::setConfiguration($configuration);
        }
         ...
         * @static 
         */
        public static function getRemoteUserInput(){
            return \Adldap\Adldap::getRemoteUserInput();
        }
         ...
         * @static 
         */
        public static function getKerberosAuthInput(){
            return \Adldap\Adldap::getKerberosAuthInput();
        }
        ...
        public static function containers(){
            return \Adldap\Adldap::containers();
        }
         ...
         * @static 
         */
        public static function computers(){
            return \Adldap\Adldap::computers();
        }
         ...
         * @static 
         */
        public static function ous(){
            return \Adldap\Adldap::ous();
        }
        ...
        public static function connect($username = null, $password = null){
            return \Adldap\Adldap::connect($username, $password);
        }
         ...
         * @static 
         */
        public static function authenticate($username, $password, $bindAsUser = false){
            return \Adldap\Adldap::authenticate($username, $password, $bindAsUser);
        }
        ...
        public static function getRootDse(){
            return \Adldap\Adldap::getRootDse();
        }
        
    }


    class PushBullet extends \Lahaxearnaud\LaravelPushbullet\LaravelPushbulletFacade{
         ...
         */
        public static function all(){
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::all();
        }
        ...
        public static function device(){
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::device();
        }
        ...
        public static function type(){
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::type();
        }
         ...
         */
        public static function user(){
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::user();
        }
        ...
        public static function devices(){
            //Method inherited from \PHPushbullet\PHPushbullet            
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::devices();
        }
        ...
        public static function channel(){
            //Method inherited from \PHPushbullet\PHPushbullet            
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::channel();
        }
        ...
        public static function push($request){
            //Method inherited from \PHPushbullet\PHPushbullet            
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::push($request);
        }
        ...
        public static function getClient(){
            //Method inherited from \PHPushbullet\PHPushbullet            
            return \Lahaxearnaud\LaravelPushbullet\LaravelPushbullet::getClient();
        }
