...
{!! Form::open(array('action' => 'ReportController@showUserReport', 'method'=> 'POST', 'class'=>'form-horizontal')) !!}

                    <div class="form-group @if ($errors->has('user')) has-error @endif">
                    {!! Form::label('user', trans('report.user'), array('class'=>'col-sm-2 control-label')) !!}
                    <div class="col-sm-10">
                    {!! Form::select('user', $users, Null, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%')) !!}
