...
<section class="content-header">
    ...
    <small>{{trans('message.titleCreate')}}</small>
    </h1>
    <ol class="breadcrumb">
...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">{{trans('message.creation')}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<div class="col-md-12">
{!! Form::select('to', [], Null, array('class'=>'form-control input-sm js-data-client', 'style'=>'width: 100%', 'data-placeholder'=>trans('message.to'))) !!}
...
<div class="col-md-12">
{!! Form::text('subject', Null, array('class'=>'form-control', 'style'=>'width: 100%', 'placeholder'=>trans('message.subj'))) !!}
...
<span>{{trans('message.delete')}}</span>
            ...
            <div class="">
              <div class="pull-right">
                ...
                {!! HTML::decode(Form::button('<i class=\'fa fa-pencil\'></i> '.trans('message.save'), array('type' => 'submit', 'class'=>'btn btn-default', 'value'=>'save', 'name'=>'action'))) !!}

               
                {!! HTML::decode(Form::button('<i class=\'fa fa-envelope-o\'></i> '.trans('message.send'), array('type' => 'submit', 'class'=>'btn btn-primary', 'value'=>'send', 'name'=>'action'))) !!}
              </div>
