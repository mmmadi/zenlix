...
<div class="col-md-9">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">{{trans('message.listOfMsg')}}</h3>
...
<table id="example1" class="table table-hover table-striped">
                ...
                <tr>
                    <th class="no-sort"></th>
                    <th class="no-sort"></th>
                    <th><center>{{trans('message.to')}} </center></th>
...
@foreach ($messages as $message)
                  ...
                  <tr @if ($message->read_flag == 'true') style="font-weight: 600;" @endif>
                    ...
                    <td class="mailbox-name"><a href="{{URL::to('/message/'.$message->message_urlhash)}}">{{$message->toUser->name or 'пусто'}}</a></td>
