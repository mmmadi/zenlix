...
<section class="content-header">
    <h1>
     <i class="fa fa-graduation-cap"></i> {{trans('help.materialCreation')}}
    <small>{{trans('help.title')}}</small>
    </h1>
    <ol class="breadcrumb">
        @include("layout.breadcrumb")
        <li>{{trans('help.title')}}</li>
        <li class="active">{{trans('help.newMaterial')}}</li>
    </ol>
</section>
        ...
        <div class="col-md-10">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-list-alt"></i> {{trans('help.newMaterial')}}</h3>
                </div>
...
{!! Form::open(array('action' => 'HelpCenterController@store', 'method'=> 'PATCH', 'class'=>'form-horizontal')) !!}
...
<em>{{trans('help.access')}}</em>
                    ...
                    <div class="col-sm-10">
                    {!! Form::select('AcessAll', ['true'=>trans('help.all'), 'false'=>trans('help.onlyGroups')], Null, array('class'=>'form-control select2')) !!}
                    </div>
                    </div>
...
{!! HTML::decode(Form::button(trans('help.create'), array('type' => 'submit', 'class'=>'btn btn-success'))) !!}
</div>
</div>
