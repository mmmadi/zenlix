...
{!! Form::open(array('action' => 'HelpCenterController@showFind', 'method'=> 'POST', 'class'=>'form-horizontal')) !!}



<div class="input-group input-group-lg">
                
                  {!! Form::text('text', null, array('class'=>'form-control','placeholder'=>trans('help.inputFind'))) !!}



                    <span class="input-group-btn">
                    {!! HTML::decode(Form::button(trans('help.find'), array('type' => 'submit', 'class'=>'btn btn-info btn-flat'))) !!}
