...
<div class="col-sm-5">
 ...
 <div class="login-logo " style="    padding: 10px; margin: 0px;">
  ...
  <div class="login-box-body" style="">
    <p class="login-box-msg">{{trans('authPage.loginToSystem')}}</p>
      ...
      <div class="row">
        <div class="col-xs-8">
          ...
          <div class="checkbox icheck">
            <label>
              {!! Form::checkbox('remember'); !!} {{trans('authPage.remember')}}
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
            ...
            {!! Form::button(trans('authPage.enter'), array('type' => 'submit', 'class'=>'btn btn-success btn-block btn-flat')); !!}
