...
<head>
  ...
  <title>ZENLIX | Reset password</title>
...
<div class="col-sm-5">
 ...
 <div class="login-logo " style="    padding: 10px; margin: 0px;">
  ...
  <div class="login-box-body" style="">
    <p class="login-box-msg">{{trans('authPage.newPass')}}</p>
...
<div class="form-group has-feedback @if ($errors->has('password')) has-error @endif">
                    {!! Form::password('password', array('class'=>'form-control input-lg', 'autocorrect'=>'off', 'autocapitalize'=>'off', 'autocomplete'=>'off', 'placeholder'=>trans('authPage.password'))); !!}
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    @if ($errors->has('password')) <p class="help-block">{{ $errors->first('password') }}</p> @endif
                    </div>

<div class="form-group has-feedback @if ($errors->has('password_confirmation')) has-error @endif">
                    {!! Form::password('password_confirmation', array('class'=>'form-control input-lg', 'autocorrect'=>'off', 'autocapitalize'=>'off', 'autocomplete'=>'off', 'placeholder'=>trans('authPage.passConfirm'))); !!}
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
            ...
            {!! Form::button(trans('authPage.resetPass'), array('type' => 'submit', 'class'=>'btn btn-success btn-block btn-flat')); !!}
