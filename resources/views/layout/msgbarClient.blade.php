...
<ul class="nav nav-tabs nav-justified control-sidebar-tabs">
          <li class="active"><a href="#control-sidebar-home-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-headphones"></i>
          {{trans('layout.supportService')}} </a></li>
...
@if ($CurUser->chatRequests->count() == 0 )
<li>
<a type="button" id="chatUIsendRequest" class="btn bg-maroon btn-flat margin">{{trans('layout.reqChat')}}</a>
</li>
@else 
<li>
<a type="button" id="chatUIsendRequest" class="btn bg-maroon btn-flat margin disabled">{{trans('layout.reqSended')}}</a>
</li>
@endif
 ...
 <div class="tab-pane" id="control-sidebar-theme-demo-options-tab">
        ...
        <span class="pull-right"> <button id="chatUIClose" style="opacity: 1; color: white; @if($CurUser->roles->role == "client") display:none; @endif" type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> </span>
        </h3>
