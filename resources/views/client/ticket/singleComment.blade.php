                 @foreach ($comments->where('visible_client', 'true') as $comment)
                  <div class="box-comment">
                    ...
                    <div class="comment-text">
                      ...
                      <a href="{{URL::to('/user/'.$comment->author->profile->user_urlhash)}}">
                        ...
                        <span class="text-muted pull-right"> {{LocalizedCarbon::instance($comment->created_at)->formatLocalized('%H:%M, %d %f %Y')}}</span>
                      </span><!-- /.username -->
                      {{$comment->text}}
