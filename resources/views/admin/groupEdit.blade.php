...
<section class="content-header">
    <h1>
     {{trans('ag.groups')}}
    <small>{{trans('ag.groupEditing')}}</small>
    </h1>
    <ol class="breadcrumb">
        @include("layout.breadcrumb")
        <li> <a href="{!! URL::to('/admin/groups'); !!}">{{trans('ag.groups')}}</a></li>
        <li class="active">{{trans('ag.groupEditing')}}</li>
    </ol>
</section>
        ...
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"> {{trans('ag.groupEditing')}}</h3>
                </div>
...
{!! Form::model($group, array('action' => array('ConfigGroupsController@update', $group->id), 'method'=> 'POST', 'class'=>'form-horizontal')) !!}
...
{!! HTML::decode(Form::button(trans('ag.makeEdit'), array('type' => 'submit', 'class'=>'btn btn-success'))) !!}
</div>
</div>
