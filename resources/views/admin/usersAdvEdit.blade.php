        ...
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"> {{trans('au.editField')}}</h3>
                </div>
...
{!! Form::model($UserField, array('action' => array('ConfigUsersController@updateAdv', $UserField->id), 'method'=> 'POST', 'class'=>'form-horizontal')) !!}
                    ...
                    <div class="col-sm-9">
                    {!! Form::select('field_type', $fieldTypes, Null, array('class'=>'form-control select2')) !!}
                    ...
                    <div class="col-sm-9">
                    {!! Form::select('visible_client', ['false'=>trans('au.no'),'true'=>trans('au.yes')], Null, array('class'=>'form-control select2')) !!}
                    ...
                    <div class="col-sm-9">
                    {!! Form::select('status', ['false'=>trans('au.no'),'true'=>trans('au.yes')], Null, array('class'=>'form-control select2')) !!}
...
{!! HTML::decode(Form::button(trans('au.save'), array('type' => 'submit', 'class'=>'btn btn-success'))) !!}
</div>
</div>
