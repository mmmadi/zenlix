...
<section class="content-header">
    <h1>
     {{trans('at.AdvField')}}
    <small>{{trans('at.EditingAdvField')}}</small>
    </h1>
    <ol class="breadcrumb">
       @include("layout.breadcrumb")
        <li><a href="{!! URL::to('/admin/ticket/adv'); !!}">{{trans('at.AdvFields2')}}</a></li>
        <li class="active">{{trans('at.EditingFieldTicket')}}</li>
    </ol>
</section>
        ...
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"> {{trans('at.EditingAdvField')}}</h3>
                </div>
...
{!! Form::model($field, array('action' => array('ConfigTicketController@updateAdv', $field->id), 'method'=> 'POST', 'class'=>'form-horizontal')) !!}
