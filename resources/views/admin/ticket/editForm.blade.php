...
<section class="content-header">
    ...
    <small>{{trans('editingTForm')}}</small>
    </h1>
    <ol class="breadcrumb">
       @include("layout.breadcrumb")
        <li><a href="{!! URL::to('/admin/ticket/forms'); !!}">{{trans('at.ticketForms')}}</a></li>
        <li class="active">{{trans('editingTForm')}}</li>
    </ol>
</section>
        ...
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"> {{trans('at.editingTForm')}}</h3>
                </div>
...
{!! Form::model($form, array('action' => array('ConfigTicketController@updateForms', $form->id), 'method'=> 'POST', 'class'=>'form-horizontal')) !!}
...
<div class="form-group">
                      ...
                      {!! Form::select('clientGroups[]', $groups, $groupsSel, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                      </div>
</div>
...
<div class="form-group">
                      ...
                      {!! Form::select('target_groups[]', $groups, $groupsTargetSel, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                      </div>
</div>
...
<div class="form-group">
                      ...
                      {!! Form::select('target_users[]', $users, $usersTargetSel, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                      </div>
</div>
<hr>
<div class="form-group">
...
<div class="form-group">
                      ...
                      {!! Form::select('subj_lists[]', $subjs, $subjsSel, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                      </div>
</div>
...
{!! Form::select('upload_files_types[]', $upload_files_types, $upload_files_typesSel, array('class'=>'form-control input-sm select2-tags', 'style'=>'width: 100%', 'data-placeholder'=>trans('at.fileTypes'), 'multiple'=>'multiple')) !!}
...
<div class="form-group">
                      ...
                      {!! Form::select('slas[]', $slas, $slasSel, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                      </div>
</div>
...
<div class="form-group">
                      ...
                      {!! Form::select('fields[]', $fields, $fieldsSel, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                      </div>
</div>
