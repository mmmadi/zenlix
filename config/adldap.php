    ...
    */
    ...
    'connection_settings' => [
        ...
        */
        ...
        'account_suffix' => env('APP_LDAP_ACCOUNT_SUFFIX', '@acme.org'),
        ...
        */
        ...
        'domain_controllers' => [ env('APP_LDAP_DOMAIN_CONTROLLERS', 'corp-dc1.corp.acme.org')],
        ...
        */
        ...
        'base_dn' => env('APP_LDAP_BASE_DN', 'dc=corp,dc=acme,dc=org'),
        ...
        */
        ...
        'admin_username' => env('APP_LDAP_ADMIN_LOGIN', 'admin'),
        'admin_password' => env('APP_LDAP_ADMIN_PASS', 'password'),
        ...
        */
        ...
        'follow_referrals' => env('APP_LDAP_FOLLOW_REFERRALS', false),
        ...
        */
        ...
        'use_ssl' => env('APP_LDAP_USE_SSL', false),
        'use_tls' => env('APP_LDAP_USE_TLS', false),
