...
class Ticket extends Model
{
    ...
    protected $dates = ['deleted_at', 'deadline_time'];
 ...
 */
    ...
    public function merged() // those who follow me

    {
        //$this->belongsToMany('App\Role', 'user_roles', 'user_id', 'role_id');
        return $this->belongsToMany('zenlix\Ticket', 'ticket_merge', 'parent_id', 'child_id')->withTimestamps();
    }
